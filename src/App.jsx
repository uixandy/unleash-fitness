      ...
      <>
        ...
        <main className="max-w-2xl mx-auto px-5 py-16">
          ...
          <p className="mt-6 text-[var(--text-secondary)] leading-relaxed">
            If you join the waitlist, we store your first name and email solely to notify you
            about UNLEASH launch and Pro updates (including personalized messages using your
            name). We don’t sell your data. You can ask to be removed anytime by contacting us
            through the app or the address used for waitlist replies.
          </p>
